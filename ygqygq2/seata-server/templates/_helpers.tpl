...
*/}}
{{- define "seata-server.metrics.image" -}}
...
*/}}
{{- define "seata-server.imagePullSecrets" -}}
...
{{- define "seata-server.checkRollingTags" -}}
...
*/}}
{{- define "seata-server.tlsSecretName" -}}
...
*/}}
{{- define "seata-server.createTlsSecret" -}}
