# mongodb-servicemonitor - Prometheus Operator with mongodb exporter servicemonitor

[mongodb-servicemonitor](https://)是Prometheus Operator监控mongodb exporter的charts
...
```bash
$ helm install my-release ./mongodb-servicemonitor
```
