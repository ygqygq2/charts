# nginx-servicemonitor - Prometheus Operator with nginx exporter servicemonitor

[nginx-servicemonitor](https://)是Prometheus Operator监控nginx exporter的charts
...
```bash
$ helm install my-release ./nginx-servicemonitor
```
...
| `metricsPort  `            | redis exporter metrics port         | `9113`                                 |
